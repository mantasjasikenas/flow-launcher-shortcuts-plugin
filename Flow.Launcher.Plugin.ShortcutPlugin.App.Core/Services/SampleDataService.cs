...
using Flow.Launcher.Plugin.ShortcutPlugin.App.Core.Models;

namespace Flow.Launcher.Plugin.ShortcutPlugin.App.Core.Services;
...
public class SampleDataService : ISampleDataSrvice
{
